...
import type { ModelOAuthBegin, ModelOAuthSignInMode } from "@cortexai-agent-hub/contracts";
import type {
  AuthInteraction,
  Credential,
  OAuthAuth,
...
> = {
  [CHATGPT_OAUTH_PROVIDER]: {
    ...
    billing:
      "Sign in with ChatGPT Plus or Pro. Uses your OpenAI subscription. CortexAI Agent Hub does not pay.",
  },
  [COPILOT_OAUTH_PROVIDER]: {
    ...
    hint: "Copilot",
    billing:
      "Sign in with GitHub Copilot. Uses your Copilot subscription. CortexAI Agent Hub does not pay.",
  },
  [XAI_OAUTH_PROVIDER]: {
    mode: "device-code",
    ...
    hint: "SuperGrok / key",
    billing:
      "Sign in with SuperGrok or X Premium, or paste an xAI API key. CortexAI Agent Hub does not pay.",
  },
