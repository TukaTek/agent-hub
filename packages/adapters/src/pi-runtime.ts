    ...
    prepareArguments: (args: unknown) => {
      ...
      if (tool.name === "destination.write") {
        return {
          ...
          title: String(raw.title ?? "CortexAI Agent Hub result"),
      ...
      if (tool.name === "shell") {
        return {
          ...
          cwd: raw.cwd ? String(raw.cwd) : "/home/cortexai-agent-hub",
        };
      }
