...
import type { ModelConnectInput, ModelCredential, ThinkingLevel } from "@cortexai-agent-hub/contracts";
import { OPENAI_COMPATIBLE_PROVIDER_ID as CONTRACT_OPENAI_COMPAT } from "@cortexai-agent-hub/contracts";
