...
export const UI_APPEARANCE_STORAGE_KEY = "cortexai-agent-hub.uiAppearance";
...
export function renderTokensCss(): string {
  return `${[
    "/* Generated by `pnpm --filter @cortexai-agent-hub/ui-tokens generate`. Edit src/index.ts instead. */",
