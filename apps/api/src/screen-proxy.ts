...
import { hasActiveComputerControl } from "@cortexai-agent-hub/adapters";
import type { ScreenCapabilityScope } from "@cortexai-agent-hub/core/node/screen-capability";
import {
  openScreenCapability,
  SCREEN_TARGET_ENDPOINT,
  sealScreenCapability,
} from "@cortexai-agent-hub/core/node/screen-capability";
