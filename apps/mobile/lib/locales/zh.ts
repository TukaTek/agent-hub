export const ZH_MESSAGES: Record<string, string> = {
  ...
  "Could not archive Assistant": "无法归档助手",
  ...
  "Could not create Assistant": "无法创建助手",
  ...
  "Could not load Assistant": "无法加载助手",
  "Could not load Assistants": "无法加载助手列表",
  ...
  "Could not save Assistant": "无法保存助手",
  ...
  Description: "描述",
  "Describe what this Assistant does": "描述这个助手的工作",
  ...
  "No matching Assistants": "没有匹配的助手",
  ...
  "Point this app at your self-hosted CortexAI Agent Hub origin — the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 CortexAI Agent Hub 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to CortexAI Agent Hub": "登录 CortexAI Agent Hub",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for CortexAI Agent Hub": "注册 CortexAI Agent Hub",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "Switching…": "正在切换…",
  "Take control": "接管控制",
  "Tap + to create an Assistant": "点按 + 创建助手",
  Team: "团队",
  "Team Computer": "团队电脑",
  ...
  "Waiting for this Assistant’s response.": "正在等待这个助手的回复。",
  "Waiting…": "等待中…",
  "What this Assistant is for": "这个助手的用途",
  ...
  "Paste the OpenAI-compatible address from your server. CortexAI Agent Hub adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，CortexAI Agent Hub 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
  "Recording a live demonstration needs desktop or web with the full computer view. You can still ask this Assistant to run saved skills from chat.":
    "录制现场演示需要桌面端或网页端的完整电脑视图。你仍可在聊天中让这个助手运行已保存的技能。",
  ...
  "This removes every message and stops current work. The Assistant, computer, memory, and routines are kept.":
    "这将删除所有消息并停止当前工作。助手、电脑、记忆和例行任务会保留。",
  "This subscription sign-in is not available in CortexAI Agent Hub yet. Use a deployment credential or choose another provider.":
    "CortexAI Agent Hub 暂不支持此订阅登录。请使用部署凭据或选择其他提供商。",
  "Tool sources": "工具源",
