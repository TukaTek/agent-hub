export const RU_MESSAGES: Record<string, string> = {
  "Archived Assistants": "Архивированные ассистенты",
  Assistant: "Ассистент",
  "Could not delete Assistant": "Не удалось удалить ассистента",
  "Could not reach the server": "Не удалось подключиться к серверу",
  "Could not restore Assistant": "Не удалось восстановить ассистента",
  "Delete this group? Assistants and their solo threads are kept.":
    "Удалить эту группу? Ассистенты и их личные чаты сохранятся.",
  ...
  "Enter your CortexAI Agent Hub server address.":
    "Введите адрес вашего сервера CortexAI Agent Hub.",
  "Show less": "Свернуть",
  Members: "Участники",
  ...
  "Point this app at your self-hosted CortexAI Agent Hub origin, the same HTTPS URL you open in a browser.":
    "Направьте это приложение на свой собственный источник CortexAI Agent Hub — тот же URL-адрес HTTPS, который вы открываете в браузере.",
  Private: "Личный",
  ...
  "That URL did not look like a CortexAI Agent Hub server":
    "Этот адрес не похож на сервер CortexAI Agent Hub",
  ...
  "Paste the OpenAI-compatible address from your server. CortexAI Agent Hub adds /v1 if needed.":
    "Вставьте OpenAI-совместимый адрес со своего сервера. При необходимости CortexAI Agent Hub добавляет /v1.",
  ...
  "This subscription sign-in is not available in CortexAI Agent Hub yet. Use a deployment credential or choose another provider.":
    "Вход по этой подписке пока недоступен в CortexAI Agent Hub. Используйте учётные данные развёртывания или выберите другого провайдера.",
