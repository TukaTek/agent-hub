...
const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    selfHost: {
      ...
      copy: "Run CortexAI Agent Hub on your machine. Your keys, your model, your data.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "CortexAI Agent Hub is Apache-2.0 licensed and runs on your own machine with your own model keys. Nothing is gated, nothing phones home.",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Hosted CortexAI Agent Hub is coming. Leave your email.",
      back: "Back",
      successTitle: "You're in.",
      successCopy:
        "We'll email you when hosted CortexAI Agent Hub is ready. Want to start today? Jump to Self-host on this page.",
      done: "Done",
      viewOnGithub: "View on GitHub",
    },
    waitlist: {
  ...
  de: {
    ...
    starFallback: "Star",
    nav: {
      home: "CortexAI Agent Hub-Startseite",
    ...
    selfHost: {
      ...
      copy: "Betreibe CortexAI Agent Hub auf deiner Maschine. Deine Keys, dein Modell, deine Daten.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "CortexAI Agent Hub ist Apache-2.0-lizenziert und läuft auf deiner Maschine mit deinen Model-Keys. Nichts ist freigeschaltet, nichts telefoniert nach Hause.",
      selfHostTitle: "Self-host",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Gehostetes CortexAI Agent Hub kommt. Hinterlasse deine E-Mail.",
      back: "Zurück",
      successTitle: "Du bist dabei.",
      successCopy:
        "Wir mailen dir, wenn gehostetes CortexAI Agent Hub bereit ist. Heute starten? Zum Self-host-Abschnitt auf dieser Seite.",
      done: "Fertig",
      viewOnGithub: "Auf GitHub ansehen",
    },
    waitlist: {
  ...
  ko: {
    ...
    selfHost: {
      eyebrow: "셀프 호스트",
      heading: "컴퓨터는 당신 것",
      copy: "당신 머신에서 CortexAI Agent Hub를 실행하세요. 키, 모델, 데이터는 모두 당신 것.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "CortexAI Agent Hub는 Apache-2.0 라이선스이며, 당신 머신에서 당신 모델 키로 실행됩니다. 잠긴 기능도, 외부로 연락하는 것도 없습니다.",
    ...
    getStartedDialog: {
      ...
      cloudHint: "호스팅 CortexAI Agent Hub가 곧 옵니다. 이메일을 남겨 주세요.",
      back: "뒤로",
      successTitle: "등록되었습니다.",
      successCopy:
        "호스팅 CortexAI Agent Hub가 준비되면 메일로 알려 드립니다. 오늘 시작하려면 이 페이지의 셀프 호스트 섹션으로 이동하세요.",
      done: "완료",
      viewOnGithub: "GitHub에서 보기",
    },
    waitlist: {
  ...
  zh: {
    ...
    selfHost: {
      eyebrow: "自托管",
      heading: "电脑归你所有",
      copy: "在你自己的机器上运行 CortexAI Agent Hub。密钥、模型、数据，都归你所有。",
      features: [
        {
          title: "任意模型，密钥归你",
    ...
    openSource: {
      ...
      copy: "CortexAI Agent Hub 采用 Apache-2.0 许可证，在你自己的机器上用你自己的模型密钥运行。没有功能墙，也不会偷偷外联。",
      selfHostTitle: "自托管",
      selfHostMeta: "现已可用",
      selfHostItems: [
        "Docker 运行器和沙箱浏览器",
    ...
    getStartedDialog: {
      ...
      cloudHint: "托管版 CortexAI Agent Hub 即将推出。留下你的邮箱。",
      back: "返回",
      successTitle: "登记成功。",
      successCopy:
        "托管版 CortexAI Agent Hub 就绪时我们会邮件通知你。想今天就上手？跳到本页的自托管部分。",
      done: "完成",
      viewOnGithub: "在 GitHub 上查看",
    },
    waitlist: {
