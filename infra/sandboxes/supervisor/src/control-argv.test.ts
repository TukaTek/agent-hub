...
import { browserProfilePathForScreen } from "@cortexai-agent-hub/core/node/desktop-runtime";
...
describe("controller argv restrictions", () => {
  it.each([
    ["env", `DISPLAY=${display}`, `CORTEXAI_AGENT_HUB_BROWSER_PROFILE=${profile}`],
    [
      "env",
      `DISPLAY=${display}`,
      "CORTEXAI_AGENT_HUB_BROWSER_PROFILE=",
      "cortexai-agent-hub-browser",
    ],
    [
      "env",
      `DISPLAY=${display}`,
      `CORTEXAI_AGENT_HUB_BROWSER_PROFILE=${profile}a`,
      "cortexai-agent-hub-browser",
    ],
    [
      "env",
      `DISPLAY=${display}`,
      `CORTEXAI_AGENT_HUB_BROWSER_PROFILE=${profile.toUpperCase()}`,
      "cortexai-agent-hub-browser",
    ],
    ["env", `DISPLAY=${display}`, `CORTEXAI_AGENT_HUB_BROWSER_PROFILE=${profile}`, "xterm"],
    [
      "env",
      `DISPLAY=${display}`,
    ...
    ["env", `DISPLAY=${display}`, `CORTEXAI_AGENT_HUB_BROWSER_PROFILE=${profile}`, "xdg-open"],
    [
      "env",
      `DISPLAY=${display}`,
      `CORTEXAI_AGENT_HUB_BROWSER_PROFILE=${profile}`,
    ...
    [
      "env",
      `DISPLAY=${display}`,
      "CORTEXAI_AGENT_HUB_BROWSER_PROFILE=/tmp/unsafe",
      "cortexai-agent-hub-browser",
    ],
    [
      "env",
      `DISPLAY=${display}`,
      `CORTEXAI_AGENT_HUB_BROWSER_PROFILE=${profile}/../other`,
      "cortexai-agent-hub-browser",
    ],
    [
      "env",
