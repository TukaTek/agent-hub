...
g '--pull-never)'
g '--offline)'
g 'CORTEXAI_AGENT_HUB_PULL_NEVER'
...
[[ "$offline_out" == *"CortexAI Agent Hub is starting"* ]] || fail "--offline did not start"
...
[[ "$old_out" != *"CortexAI Agent Hub setup failed:"* ]] || fail "old Compose --offline should not hard-fail: $old_out"
[[ "$old_out" == *"CortexAI Agent Hub is starting"* ]] || fail "old Compose --offline should continue: $old_out"
